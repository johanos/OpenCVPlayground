...
extern "C" int __declspec(dllexport) __stdcall testFunc() {
	Mat image;
	//image = imread("C:\\Users\\Johanos\\Desktop\\Sample.jpg", IMREAD_COLOR); // Read the file
	image = imread("./Sample.jpg", IMREAD_COLOR); // Read the file
